...
public class ProductDao {
    ...
    public static ArrayList getAllProducts(String category) throws SQLException {
        ...
        try {
            ...
            String sql = "SELECT product.productId,\n"
                    ...
                    + "    product.category\n"
                    + "FROM quotationmanagementsystem.product where category=?;";
    ...
    public static int addProduct(int productId, String productName, Double productPrice, Double discountRate, String productMake,
