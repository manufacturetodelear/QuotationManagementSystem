...
public class DealerAction implements SessionAware{
    ...
    public String executeDealer() throws Exception {
        String status1;
        int i = DealerDao.addDealer(dealerId, dealerUserName, password, dealerFirstName, dealerLastName, dealerAddress, dealerEmailId, dealerContactInfo,zipcode,status);
        if(i>0)
        {
