...
public class DealerDao {
    ...
    public static int addDealer(int dealerId, String dealerUserName, String password,String dealerFirstName,String dealerLastName,
        ...
        try {
            ...
            ps.setString(2, dealerUserName);
            ps.setString(3, password);
            ps.setString(4, dealerFirstName);
            ps.setString(5, dealerLastName);
            ps.setString(6, dealerAddress);
            ps.setString(7, dealerEmailId);
            ps.setString(8, dealerContactInfo);
